...
const CONFIG = {
  ...
  clubs: {
    ...
    level:   { key:"level",   title:"Пятак Level",   pcs:28, extras:["DUO 777", "DUO 999", "Кассовый ПК"], hotel:[] },
  },

  tariffs: {
    pyatak:  { "Обычный ПК": 500, "VIP зал": 750 },
    premium: { "Обычный ПК": 600, "Кибер-отель": 900 },
    level:   { "Обычный ПК": 450 }
  }
};
